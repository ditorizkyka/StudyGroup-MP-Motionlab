...
class FavoritePage extends GetView<FavoriteController> {
  ...
  Widget build(BuildContext context) {
    ...
    favoriteController.getFavoritePrd();
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.inter(
                                color:
                                    const Color(0xff161B28).withOpacity(0.58)),
                          ),
                        ],
                      ),
                    ),
                  ...
                  favoriteController.isLoading.value == true
                      ...
                      : Padding(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: productController.favoritePrd.length,
                            itemBuilder: (context, index) {
                              return CardProduct(
                                item: productController.favoritePrd[index],
                                indexProduct: index,
